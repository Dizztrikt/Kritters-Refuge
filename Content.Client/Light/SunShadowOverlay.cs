...
public sealed partial class SunShadowOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        if (resources.Target?.Size != targetSize)
        {
            resources.Target?.Dispose();
            resources.Target = _clyde
        ...
        foreach (var grid in _grids)
        {
            ...
            args.WorldHandle.RenderInRenderTarget(resources.Target,
                () =>
                {
                    var invMatrix =
                        resources.Target.GetWorldToLocalMatrix(eye, scale);
            ...
            _clyde.BlurRenderTarget(viewport, resources.Target, resources.BlurTarget!, eye, 1f);
            ...
            args.WorldHandle.RenderInRenderTarget(viewport.LightRenderTarget,
                () =>
                {
                    ...
                    worldHandle.DrawTextureRect(resources.Target.Texture, worldBounds, Color.Black.WithAlpha(alpha));
                }, null);
        }
    }

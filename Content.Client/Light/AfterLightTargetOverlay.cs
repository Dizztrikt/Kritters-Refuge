...
public sealed partial class AfterLightTargetOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        var lightResources = lightOverlay.GetCachedForViewport(viewport);
        ...
        var diff = lightResources.EnlargedLightTarget!.Size - viewport.LightRenderTarget.Size;
        var halfDiff = diff / 2;
        ...
        args.WorldHandle.RenderInRenderTarget(viewport.LightRenderTarget,
            () =>
            {
                ...
                worldHandle.DrawTextureRectRegion(lightResources.EnlargedLightTarget.Texture, bounds, subRegion: subRegion);
            }, Color.Transparent);
    }
}
